...
def load_data():
    data = pd.read_csv('c:/Users/stive/OneDrive/Documents/Ing_Sistemas/Analisis de Datos/Analisis-de-datos-masivos-main/Taller AWS 1/datos_energia.csv')
    
    # Convertimos 'time' a datetime y lo ponemos como índice
